<?php 
  ...
  $query_table = "SELECT * FROM nwsc_data";
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
      <div class="container">
        <a class="navbar-brand" href="dashboard.php">Water Quality monitoring System</a>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="fa fa-gear"></span> Dashboard <small>WATER QUALITY PARAMETER DATA</small></h1>
          </div>
          <div class="col-md-2">
            <div class="dropdown">
